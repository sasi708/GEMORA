    ...
    <div className="mx-auto max-w-7xl px-6 py-10">
      ...
      <div className="grid grid-cols-1 gap-10 lg:grid-cols-[340px_1fr]">
        ...
        <div className="space-y-4">
          ...
          <input className="w-full rounded-md border px-3 py-1.5 text-xs" placeholder="Street" />
          <input className="w-full rounded-md border px-3 py-1.5 text-xs" placeholder="Lane" />
          <input className="w-full rounded-md border px-3 py-1.5 text-xs" placeholder="District" />
          <input className="w-full rounded-md border px-3 py-1.5 text-xs" placeholder="Country" />

          <p className="mt-3 text-xs font-medium text-gray-700">
            Enter your Mobile Number
          </p>
          <input className="w-full rounded-md border px-3 py-1.5 text-xs" placeholder="Phone Number" />
        ...
        {/* RIGHT COLUMN (BACK BUTTON + DESCRIPTION + MORE FROM STORE) */}
        <div className="space-y-10">
          ...
          {/* MORE FROM STORE – RIGHT COLUMN BELOW */}
          <div className="border-t pt-10">
            ...
            <div className="grid grid-cols-2 gap-6 md:grid-cols-4">
              {[
                { img: "Gem cutting Machine 02.jpeg", name: "Gem Cutting Machine", price: "Rs. 50,000.00" },
                { img: "Torch.jpeg", name: "Torch", price: "Rs. 7,500.00" },
                { img: "Scale.jpeg", name: "Scale", price: "Rs. 6,500.00" },
              ].map((item, i) => (
